...
if [[ ${TARNAME} == "D" ]]; then
    echo "root -l -b 'getCorrection.C(\"${TARNAME}\",${BINNAME},${BINNDIM}, \"${CUTLIST}\", \"C\")'"   >> ${jobfile}
    echo "root -l -b 'getCorrection.C(\"${TARNAME}\",${BINNAME},${BINNDIM}, \"${CUTLIST}\", \"Fe\")'"  >> ${jobfile}
    echo "root -l -b 'getCorrection.C(\"${TARNAME}\",${BINNAME},${BINNDIM}, \"${CUTLIST}\", \"Pb\")'"  >> ${jobfile}
else
