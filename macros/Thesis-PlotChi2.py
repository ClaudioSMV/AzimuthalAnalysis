...
# parser.add_option('-a', dest='allTargets', action='store_true', default = False, help="Join all targets info")
...
# runAllTargets = options.allTargets
...
fit_type = mS.GetFitMethod(options.inputCuts)
