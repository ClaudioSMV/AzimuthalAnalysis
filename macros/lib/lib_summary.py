from lib_cuts import cuts_list_short, available_cuts_at_this_stage
from lib_error import check_list_has_one_element
from lib_constants import list_of_targets_sets, cuts_legend

def get_set_of_targets(input_cuts, get_set_tag = False):
# Return list with targets used in liquid or solid set
    possible_sets = available_cuts_at_this_stage("Summary", True)
    cut_tags = cuts_list_short(input_cuts)
...
# TODO: Include mySumFunctions.py functions!!
